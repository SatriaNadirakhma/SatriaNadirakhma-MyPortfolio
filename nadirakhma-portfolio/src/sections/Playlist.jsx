        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-5 gap-2 sm:gap-4 mb-12 sm:mb-14">
          {ALBUM_COVERS.map((cover, index) => (
            <a
              ...
              className={`block rounded-[4px] border border-gray-300 dark:border-white/[0.07] overflow-hidden transition-colors duration-150 hover:border-gray-400 dark:hover:border-white/25 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 ${
