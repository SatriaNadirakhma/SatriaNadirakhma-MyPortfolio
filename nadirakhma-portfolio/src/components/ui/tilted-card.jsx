...
// Adapted from a TSX snippet the same way MagneticButton lives in this
// folder — kept the tilt/spring logic 1:1, just dropped the TypeScript
// types and switched framer-motion -> motion/react to match the rest of
// this project's imports (see Hero.jsx). If your other /components/ui
// files are actually .tsx, feel free to rename this back and re-add
// types; nothing about the logic below depends on JS vs TS.
